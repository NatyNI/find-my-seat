...
const ShowTable = () =>{
    ...
    return(
        ...
        <div className="flex flex-col items-center p-1">
            ...
            <button
                onClick={() =>navigate("/")}
                className="fixed bottom-3 p-1.5 border-1 border-black rounded-lg p-1 text-white text-xs font-bold bg-gradient-to-l from-gray-600 via-gray-500 to-gray-400"
            >
                ÎNAPOI LA CĂUTARE
            </button> <br/>
           {/* 
